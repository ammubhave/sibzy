...
def populateFromGrubhub():        
    for url in urls:
        ...
        with contextlib.closing(urllib2.urlopen("https://www.grubhub.com/restaurant/" + url)) as spage:
            ...
            loc = Location(latitude = latitude.group(1), longitude = longitude.group(1), address = street.group(1), city = city.group(1), state = state.group(1), country = 'US', phone = telephone.group(1))
            loc.save()
